...
public class Jogo2 {
	...
	public Jogo2 (long tempo_de_jogo)
	{
		//this.gui=gui;
		rand = new Random();
	...
	public void setupInfo(int jogador){
		jogadorAtual = listaJogadores.get(jogador);
	...
	public void listaTerrenos(){
		String listaTerrenos="Lista de terrenos: [";
		for(int k=0;k<jogadorAtual.getListaTerreno().size();k++)
		{
			listaTerrenos=listaTerrenos+jogadorAtual.getlistaTerreno().get(k).getNome()+"\n";
		}
		listaTerrenos=listaTerrenos+"]\n";
		JOptionPane.showMessageDialog(null,listaTerrenos ,Messages.getString("SYSTEM_NAME"), JOptionPane.INFORMATION_MESSAGE);
		return;
	}
...
jogadorAtual.setPosicao(posicaoAtual);
	...
	public void setTerrenoAtual(Terreno terrenoAtual) {
